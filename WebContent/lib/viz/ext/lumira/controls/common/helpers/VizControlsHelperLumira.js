...
jQuery.sap.declare('sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira');

sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira = {};

sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira.getFeedInstances = function(feeds) {
    if (feeds) {
...
sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira.updateAxis = function(dimensions, vizType, feeds) {
    ...
    var feedDefsMap = sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira._getFeedDefsMap(vizType);
 ...
 */
sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira.getFakedDataInstance = function(vizType, vizData, feeds) {
    var getFeedInstances = sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira.getFeedInstances;
    var getDataInstance = sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira.getDataInstance;
 ...
 * Used in VizContainer only
 */
sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira.getDataInstance = function(vizData) {
    if (vizData) {
 ...
 */
sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira.updateFeedsByAAIndex = function(vizType, feeds) {
    if (!feeds || feeds.length === 0 || feeds.length === 1) {
        return feeds;
    }
    var vizFeedDefsMap = sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira._getFeedDefsMap(vizType);
    if (vizFeedDefsMap) {
 ...
 * Used in VizContainer only
 */
sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira.getSwitchBarGroups = function() {
...
sap.viz.ext.lumira.controls.common.helpers.VizControlsHelperLumira._getFeedDefsMap = function(vizType) {
    var allFeeds;
    try {
