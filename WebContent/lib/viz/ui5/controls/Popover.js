...
sap.viz.ui5.controls.Popover.prototype._createPopover=function(){this._Popover=new sap.viz.controls.popover.PopOver({actionItems:this.getActionItems(),customDataControl:this.getCustomDataControl(),formatString:this.getFormatString()});this._registerControl('sap.viz.controls.popover.PopOver',this._Popover);};
