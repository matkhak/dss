...
sap.viz.ui5.controls.common.BaseControl.prototype.init=function(){this._app$=null;this._controls={};this._requestedLoad=null;this._handlers={'resize':null};this._theme=null;this._locale=null;this._pendingRerendering=false;this._resourceLoaded=false;sap.viz._initializeVIZControls(this instanceof sap.viz.ui5.VizContainer,jQuery.proxy(function(s){this._resourceLoaded=s;this.invalidate();setTimeout(function(){if(!this.getUIArea()){this._render();}}.bind(this),0);},this));};
